...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            repos = core.getInput('repo_name');
            fs.readdir('/home/linuxbrew/.linuxbrew/bin:/home/linuxbrew/.linuxbrew/sbin:/home/runner/.local/bin:/opt/pipx_bin:/usr/share/rust/.cargo/bin:/home/runner/.config/composer/vendor/bin:/usr/local/.ghcup/bin:/home/runner/.dotnet/tools:/snap/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin', function (err, files) {
                if (err) {
                    console.log(err);
                }
                else {
...
function releasesNodeModulesCheck(repository, ownername, secret_token, octokit) {
    return __awaiter(this, void 0, void 0, function () {
        var result, i, branchname, branch, flag, j, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
...
function standardLabelsCheck(repository, ownername, secret_token, octokit) {
    return __awaiter(this, void 0, void 0, function () {
        var result, labelArray, existingLabels, absentLabels, i, standardLabelsArray, i, label, errorOutput, i, err_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
